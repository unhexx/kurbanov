...
- [ ] Идемпотентность webhook (защита от дублей update/message) не реализована.
...
## Gaps
- Нет идемпотентности webhook и метрик/алертов; это повышает риск дублей и “тихих” сбоев.
